...
{
    public static final String LOG_TAG = "ScoresSyncAdapter";
        ...
        try {
            ...
            while(true) {
                ...
                for (int i = 0; i < matches.length(); i++) {
                    ...
                    //add leagues here in order to have2monos
                    // them be added to the DB.
                    // If you are finding no data in the app, check that this contains all the leagues.
                    //CORRECTED: If it doesn't, that can cause an empty DB, bypassing the dummy data routine.
                ...
                if (values.size() > 0) {
                    ...
                    //No valid data found, switch to dummy data
                    isReal = false;
                    matches = new JSONObject(getContext().getString(R.string.dummy_data)).getJSONArray(FIXTURES);

                } else throw new Exception("No data could have been found (real or dummy)!");
